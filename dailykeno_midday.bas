REM *** Daily Keno Midday Package Version 2019
REM *** Written by: Russ Campbell
REM
REM *** Last Update : November 26 2018 - 1:00 AM
REM
...
LOCATE 10, 14
PRINT "       Release Date  : Nov 26 2018 - 7:30 AM        "
LOCATE 11, 14
PRINT "       Registered To :                              "
LOCATE 11, 30
PRINT reg$
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 5, 8
PRINT "        Daily Keno Package Midday Version 2019  Main Menu         "
...
ELSEIF answer$ = "%" THEN
    ...
    owner$ = "Russ Campbell"
    registered$ = reg$
    distribute$ = "Russ Campbell"
    serial$ = reg2$
    version$ = "Daily Keno Midday Version"
    release$ = "November 26 2018  7:30 AM"
    pass$ = "Omnimon43"
    IF pass2$ = pass$ THEN
        CLS
        PRINT
...
PRINT
FOR iii = 1 TO 10
    PRINT USING "  Num ## : ####    Num ## : ####"; iii; outpt(iii); iii + 10; outpt(iii + 10)
    PRINT USING "  Num ## : ####    Num ## : ####"; iii + 20; outpt(iii + 20); iii + 30, (iii + 30)
    PRINT USING "  Num ## : ####    Num ## : ####"; iii + 40; outpt(iii + 40); iii + 50, (iii + 50)
    PRINT USING "  Num ## : ####    Num ## : ####"; iii + 60; outpt(iii + 60)
NEXT iii
IF hardcopy$ = "Y" THEN
    LPRINT
...
IF crs$ = "Y" THEN COLOR 10, 5
LOCATE 3, 7
PRINT "            Daily Keno Version 2019 Midday Barchart Menu           "
LOCATE 13, 7
PRINT ""
LOCATE 5, 7
IF crs$ = "Y" THEN COLOR 15, 3
...
IF crs$ = "Y" THEN COLOR 1, 7
LOCATE 8, 7
PRINT "  [A]     Display a bargraph of Daily Keno  Low Numbers.          "
LOCATE 9, 7
PRINT "  [B]     Display a bargraph of Daily Keno  Average Numbers.      "
LOCATE 10, 7
PRINT "  [C]     Display a bargraph of Daily Keno  High Numbers.         "
LOCATE 11, 7
PRINT "  [D]     Display a bargraph of Daily Keno  All Numbers.          "
LOCATE 12, 7
PRINT "  [E]     Display a normal chart of all numbers drawn to date.    "
LOCATE 13, 7
PRINT "  [F]     Change the graphics mode on this program.               "
LOCATE 19, 25
...
FOR i = 1 TO linecounter
    ...
    IF match > 2 THEN
        CLS
        PRINT "Match for : ";
        PRINT USING "## ## #### ## ## ## ## ## ## ## ## ##"; chart(1, 1); chart(i, 2); chart(i, 3); chart(i, 4); chart(i, 5); chart(i, 6); chart(i, 7); chart(i, 8); chart(i, 9); chart(i, 10)
        PRINT USING "           ## ## ## ## ## ## ## ## ##"; chart(i, 11); chart(i, 12); chart(i, 13); chart(i, 14); chart(i, 15); chart(i, 16); chart(i, 17); chart(i, 18); chart(i, 19); chart(i, 20);
        PRINT "  > "; match; " Correct."
        ...
        LPRINT
        LPRINT USING "              ## ## ## ## ## ## ## ## ##"; chart(i, 11); chart(i, 12); chart(i, 13); chart(i, 14); chart(i, 15); chart(i, 16); chart(i, 17); chart(i, 18); chart(i, 19); chart(i, 20);
...
CLS
PRINT
PRINT "Daily Keno Midday Version 2019 Winning Numbers Entry"
PRINT "----------------------------------------------------"
PRINT
...
LOCATE 4, 18
PRINT "      Daily Keno Midday Version 2019 Print Menu         "
PRINT
IF crs$ = "Y" THEN COLOR 3, 8
LOCATE 3, 17
PRINT CHR$(201)
...
CLS
PRINT
PRINT "Partial List of winning numbers."
partial = 1
PRINT
...
FOR i = 1 TO linecounter
    ...
    PRINT USING pat$; chart(i, 1); chart(i, 2); chart(i, 3); chart(i, 4); chart(i, 5); chart(i, 6); chart(i, 7); chart(i, 8); chart(i, 9); chart(i, 10); chart(i, 11); chart(i, 12); chart(i, 13); chart(i, 14); chart(i, 14); chart(i, 15); chart(i, 16); chart(i, 17); chart(i, 18); chart(i, 19); chart(i, 20); chart(i, 21); chart(i, 22); chart(i, 23)
    qzqzqz:
NEXT i
DO WHILE INKEY$ = ""
LOOP
GOTO printmenu
81582619:
IF code1 = 5.1234567890 AND code2 = 5.2345678901 AND code3 = 5.3456789012 THEN c3herxoa = 81582619
RETURN
errorhandle:
CLS
PRINT
...
FOR jjj = 1 TO 70
    FOR iii = 1 TO linecounter
        IF chart(iii, 4) = jjj OR chart(iii, 5) = jjj OR chart(iii, 6) = jjj OR chart(iii, 7) = jjj OR chart(iii, 8) = jjj OR chart(iii, 9) = jjj OR chart(iii, 10) = jjj OR chart(iii, 11) = jjj OR chart(iii, 12) = jjj OR chart(iii, 13) = jjj OR chart(iii, 14) = jjj OR chart(iii, 15) = jjj OR chart(iii, 16) = jjj OR chart(iii, 17) = jjj OR chart(iii, 18) = jjj OR chart(iii, 19) = jjj OR chart(iii, 20) = jjj OR chart(iii, 21) = jjj OR chart(iii, 22) = jjj OR chart(iii, 23) = jjj THEN
            count = count + 1
            kkk = iii
            IF count = 1 THEN
                day1 = chart(iii, 2)
...
GOTO main
2193735:
IF code1 = 5.1234567890 AND code2 = 5.2345678901 AND code3 = 5.3456789012 THEN c3herxoa = 2193735
RETURN
search:
CLS
PRINT
...
END IF
IF code1 = 5.1234567890 AND code2 = 5.2345678901 AND code3 = 5.3456789012 THEN c3herxoa = 8327562
day2:
...
FOR i = 1 TO linecounter
    ...
    ELSEIF chart(i, 3) = year2 AND chart(i, 1) = month2 AND chart(i, 2) = day2 THEN
        ...
        PRINT "8th   : ", chart(i, 11)
        PRINT "9th   : ", chart(i, 12)
        PRINT "10th  : ", chart(i, 13)
        PRINT "11th  : ", chart(i, 14)
        PRINT "12th  : ", chart(i, 15)
        PRINT "13th  : ", chart(i, 16)
        PRINT "14th  : ", chart(i, 17)
        PRINT "15th  : ", chart(i, 18)
        PRINT "16th  : ", chart(i, 19)
        PRINT "17th  : ", chart(i, 20)
        PRINT "18th  : ", chart(i, 21)
        PRINT "19th  : ", chart(i, 22)
        PRINT "20th  : ", chart(i, 23)
        PRINT
        PRINT "Press any key to continue ... "
        PRINT
        DO WHILE INKEY$ = ""
